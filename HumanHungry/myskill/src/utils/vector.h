...
public:
 ...
 void set_y(num ny){
  ...
  vector2d<num> rotate2same_coord_standard(const double a) const;
  vector2d<num> rotate2opp_coord_standard(const double a) const;
...
template <class num>
vector2d<num> vector2d<num>::rotate2same_coord_standard(const double a) const
{
  vector2d<num> q;
  double s,c;
...
template <class num>
vector2d<num> vector2d<num>::rotate2opp_coord_standard(const double a) const
{
	vector2d<num> q;
	double s, c;
	s = sin(a);
