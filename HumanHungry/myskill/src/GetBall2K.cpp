...
void isSimulate(const WorldModel* model){
	...
	isSimulation ? away_ball_dist_x = 20 : away_ball_dist_x = 12;
	isSimulation ? away_ball_dist_y = 20 : away_ball_dist_y = 12;
}
...
PlayerTask player_plan(const WorldModel* model, int robot_id){
	...
	const point2f& receive_ball_player = model->get_our_player_pos(KICKER_ID);
