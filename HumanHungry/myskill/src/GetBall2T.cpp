...
//robot_id为拿球小车车号，TIER_ID为朝向球员编号
PlayerTask player_plan(const WorldModel* model, int robot_id){
	...
	//获得我方TIER_ID小车坐标位置信息
	const point2f& receive_player_pos = model->get_our_player_pos(TIER_ID);
	...
	//我方receier_id小车朝向信息，
	const float rece_dir = model->get_our_player_dir(TIER_ID);
	...
	if (TIER_ID == robot_id){	// 如果传入的两个参数相同，则朝向球门GetBall拿球
		cout << "=================================================== 朝向球门拿球 ===================================================" << endl;
